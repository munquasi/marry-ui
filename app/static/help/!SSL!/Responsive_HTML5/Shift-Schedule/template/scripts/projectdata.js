...
rh.consts('DEFAULT_TOPIC', encodeURI("#Shift.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.htm"));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '2C340D5D-11F9-46E7-A12D-B94380A21FE0' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "G4S Javelin Schedule help file");
