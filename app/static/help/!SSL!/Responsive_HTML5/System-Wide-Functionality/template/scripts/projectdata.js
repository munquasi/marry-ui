...
rh.consts('DEFAULT_TOPIC', encodeURI("#About_Operations.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.htm"));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '1C3FBDE2-365F-4069-B200-F4B0B0053894' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Javelin-Help");
