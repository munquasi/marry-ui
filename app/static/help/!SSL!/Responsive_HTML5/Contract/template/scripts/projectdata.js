...
rh.consts('DEFAULT_TOPIC', encodeURI("#Contract_Management.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.htm"));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '14682C60-45BD-4519-8C6B-0555EEC0485A' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "G4S Javelin Contract Management");
