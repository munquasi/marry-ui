...
rh.consts('DEFAULT_TOPIC', encodeURI("#Payroll/Create_New_Payroll.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.htm"));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '05086D55-F78B-4A29-BEF2-3B771DA2497C' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Javelin-Project");
