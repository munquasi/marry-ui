...
rh.consts('DEFAULT_TOPIC', encodeURI("#Time.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.htm"));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '6D6D8104-4039-4EC1-BA56-6718606658BC' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "G4S Javelin Help");
