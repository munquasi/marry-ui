...
rh.consts('DEFAULT_TOPIC', encodeURI("#Javelin-reports.docx_files/Reports.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.htm"));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', 'D9B6A2A9-BE7D-4B89-A112-09EB9B7F376A' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Javelin Reports");
