...
rh.consts('DEFAULT_TOPIC', encodeURI("#Payroll.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.htm"));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', 'CBD482BC-993C-4271-845B-B79277956C43' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "G4S javelin payroll");
